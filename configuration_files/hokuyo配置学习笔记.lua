...
options = {
  ...
  -- 将"provide_odom_frame" 设置为true的时候， cartographer会通过激光匹配估计等手段，来产生并发布odom。
  -- 一般如果无里程计发布， 并且机器人又需要odom坐标系的时候就启用该功能， 由cartographer来发布相应的消息
  -- 【是否可以利用cartographer的定位模式，代替导航时的里程计？？？】
